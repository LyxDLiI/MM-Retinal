...
if __name__ == "__main__":
    ...
    for i in range(total_part_number):
        ...
        folder_path = book_path + 'images_raw/part1'
        new_folder_path = book_path + 'images/'
        output_path = book_path + 'caption/part1' + str(i+1) + '_final.csv'
        ...
        result = rename_all_pictures_book4(folder_path,new_folder_path,df)      #replace
